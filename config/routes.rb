MbPhotoDesign::Application.routes.draw do
  ...
  match "invoice_results/:id" => "main#invoice_results", :via => :get, :as => 'invoice_results'
  match "customer_information" => "main#customer_information", :via => :get, :as => 'customer_information'
