...
class InvoiceItemsControllerTest < ActionController::TestCase
  ...
  test "should create invoice_item" do
    assert_difference('InvoiceItem.count') do
      post :create, invoice_item: { order_id: @invoice_item.order_id, product_id: @invoice_item.product_id, quantity: @invoice_item.quantity, taxes: @invoice_item.taxes, total: @invoice_item.total }
    end
  ...
  test "should update invoice_item" do
    put :update, id: @invoice_item, invoice_item: { order_id: @invoice_item.order_id, product_id: @invoice_item.product_id, quantity: @invoice_item.quantity, taxes: @invoice_item.taxes, total: @invoice_item.total }
    assert_redirected_to invoice_item_path(assigns(:invoice_item))
  end
